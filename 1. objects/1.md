...
for (var obj in bookArray) {
    console.log(`${bookArray[obj]["title"]} by ${bookArray[obj]["author"]}`);
    if (bookArray[obj]["alreadyRead"]) {
        console.log(`You already read ${bookArray[obj]["title"]} by ${bookArray[obj]["author"]}`);
    }
    else {
        console.log(`You still need to read ${bookArray[obj]["title"]} by ${bookArray[obj]["author"]}`);   
    }
}
```
